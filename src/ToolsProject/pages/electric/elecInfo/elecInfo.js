        ...
        <Row>
          ...
          <Col md={7}>
            <p className={`leading-relaxed mt-4 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              لوریم ایپسوم یک جمله از قبل نوشته شده است که به شگل اتومات تولید
              میگردد لوریم ایپسوم یک جمله از قبل نوشته شده است که به شگل اتومات
              تولید میگردد لوریم ایپسوم یک جمله از قبل نوشته شده است که به شگل
              اتومات تولید میگردد لوریم ایپسوم یک جمله از قبل نوشته شده است که
              به شگل اتومات تولید میگردد لوریم ایپسوم یک جمله از قبل نوشته شده
              است که به شگل اتومات تولید میگردد لوریم ایپسوم یک جمله از قبل
              نوشته شده است که به شگل اتومات تولید میگردد لوریم ایپسوم یک جمله
              از قبل نوشته شده است که به شگل اتومات تولید میگردد لوریم ایپسوم یک
              جمله از قبل نوشته شده است که به شگل اتومات تولید میگردد لوریم
              ایپسوم یک جمله از قبل نوشته شده است که به شگل اتومات تولید میگردد
              لوریم ایپسوم یک جمله از قبل نوشته شده است که به شگل اتومات تولید
              میگردد لوریم ایپسوم یک جمله از قبل نوشته شده است که به شگل اتومات
              تولید میگردد لوریم ایپسوم یک جمله از قبل نوشته شده است که به شگل
              اتومات تولید میگردد لوریم ایپسوم یک جمله از قبل نوشته شده است که
