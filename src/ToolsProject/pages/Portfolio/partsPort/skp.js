...
import myPhoto from "../../images/SKQ.JPG" ;
...
function SKP() {
  ...
  return (
    ...
    >
          ...
          <div className="w-full px-4">
            <ul className="mb-12 flex flex-wrap justify-center space-x-4 mt-8">
              ...
              <li className="mb-2">
                <Link 
                  to="/port/gleaning"
                  className={`inline-block rounded-lg px-12 mx-8 py-3 text-center text-base font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${
                    darkMode 
                      ? 'bg-blue-700 text-white hover:bg-blue-600' 
                      : 'bg-blue-500 text-white hover:bg-blue-600'
                  }`}
              ...
              <li className="mb-2">
                <Link 
                  to="/port/reference"
                  className={`inline-block rounded-lg px-12 py-3 text-center text-base font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${
                    darkMode 
                      ? 'bg-blue-700 text-white hover:bg-blue-600' 
                      : 'bg-blue-500 text-white hover:bg-blue-600'
                  }`}
      ...
      <h1 className={`text-center relative top-12 my-4 ${darkMode ? 'text-green-500' : 'text-green-700'}`}>S_K_Q Project</h1>
      <h3 className={`text-xl font-bold text-center mt-16 ${darkMode ? 'text-white' : 'text-dark'}`}>
                بازی هیجان انگیز و ناب 
                </h3>

      <p className={`relative top-4 ${darkMode ? 'text-gray-300' : 'text-body-color'}`}>
      ...
      <img src={myPhoto} alt="Mehro" className="h-96 w-[700px] m-auto p-8 " />
