...
function Todo() {
  ...
  return (
    ...
    >
      ...
      <h1 className={`text-center relative top-12 my-4 ${darkMode ? 'text-green-500' : 'text-green-700'}`}>ToDo Project</h1>
      <h3 className={`text-xl font-bold text-center mt-16 ${darkMode ? 'text-white' : 'text-dark'}`}>
                  بهترین سایت برای برنامه ریزی کردن
                </h3>

      <p className={`relative top-8 ${darkMode ? 'text-gray-300' : 'text-body-color'}`}>
