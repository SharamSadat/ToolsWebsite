...
import MyPhoto from "../../images/modeling.JPG" ;
  ...
  <ToolsNavbar />
   ...
   <section
    ...
    >
      ...
      <h1 className={`text-center relative top-12 my-4 ${darkMode ? 'text-green-500' : 'text-green-700'}`}> Modeling Project</h1>
      <h3 className={`text-xl font-bold text-center mt-16 ${darkMode ? 'text-white' : 'text-dark'}`}>
                   طرح و نمایش لباس ها و مودل های ناب جهان
                </h3>

      <p className={`relative mt-4 ${darkMode ? 'text-gray-300' : 'text-body-color'}`}>
      ...
      Optio, nisi. Nam, suscipit. Dolores repellendus eius ipsa natus quas beatae molestiae, vero, fuga blanditiis ex eveniet? Ipsam recusandae earum explicabo omnis quidem cumque eligendi delectus, quis consequatur, vel ut?
           ...
           <img src={MyPhoto} alt="mehro" className="h-96 w-[600px] mr-[450px] relative mt-4" />
