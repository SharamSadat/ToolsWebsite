...
import MyPhoto from "../../images/unique.JPG" ;
  ...
  <ToolsNavbar />
   ...
   <section
    ...
    >
      ...
      <h1 className={`text-center relative top-12 my-4 ${darkMode ? 'text-green-500' : 'text-green-700'}`}> Unique News</h1>
      <h3 className={`text-xl font-bold text-center mt-16 ${darkMode ? 'text-white' : 'text-dark'}`}>
                 با ما از اخبار ناب و سراسر جهان با خبر شوید
                </h3>
