            ...
            <div className="w-full px-4">
              <ul className="mb-12 flex flex-wrap justify-center space-x-1">
                <li className="mb-1">
                  <Link
                    to="/port/AllProj"
                    className="inline-block  hover:scale-90 ease-in-out hover:!bg-blue-600 !font-bold hover:!text-white ml-1 border-2 !border-blue-500 rounded-lg px-5 py-2 text-center !text-blue-700 transition md:py-3 lg:px-8 btn btn-outline"
                  >
                     {t.allProjects}
                  </Link>
                </li>
                <li className="mb-1">
                  <Link
                    to="/port/gleaning"
 className="inline-block  hover:scale-90 ease-in-out hover:!bg-blue-600 !font-bold hover:!text-white border-2 !border-blue-500 rounded-lg px-5 py-2 text-center !text-blue-700 transition md:py-3 lg:px-8 btn btn-outline"                  >
                    {t.glenings}
                  </Link>
                </li>
                <li className="mb-1">
       ...
       <div className="card-grid mt-12">
            <div className="enhanced-card">
              ...
              <div className="enhanced-card-body text-center">
                ...
                <h3 className="enhanced-card-title">{t.skp}</h3>
                <Link 
                  to="/port/Allproj/skq"
            ...
            <div className="enhanced-card">
              ...
              <div className="enhanced-card-body text-center">
                ...
                <h3 className="enhanced-card-title">{t.todoInfo}</h3>
                <Link
                  to="/Allproj/Todo"
                  className="btn btn-primary mt-4"
                >
            ...
            <div className="enhanced-card">
              ...
              <div className="enhanced-card-body text-center">
                ...
                <h3 className="enhanced-card-title">{t.findNumberInfo}</h3>
                <Link
                  to="/Allproj/Game"
                  className="btn btn-primary mt-4"
                >
            ...
            <div className="enhanced-card">
              ...
              <div className="enhanced-card-body text-center">
                ...
                <h3 className="enhanced-card-title">{t.modeling}</h3>
                <Link
                  to="/Allproj/modeling"
                  className="btn btn-primary mt-4"
                >
            ...
            <div className="enhanced-card">
              ...
              <div className="enhanced-card-body text-center">
                ...
                <h3 className="enhanced-card-title">{t.unique}</h3>
                <Link
                  to="/Allproj/news"
                  className="btn btn-primary mt-4"
                >
